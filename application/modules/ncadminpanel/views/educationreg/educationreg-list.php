                           ...
                           <?php echo form_open('',' id="common_search" class="form-inline"');?>
                            <div class="form-group">
                             <?php  $search_array = array(
                             		 '' => get_label('select'),
                                     'er_name' => get_label('er_name'),
                             	     'er_mobileno' => get_label('er_mobileno'),
                             	     'er_year_of_passing' => get_label('er_year_of_passing'),
                                     'er_ten_total_mark' => get_label('er_ten_total_mark'),
                                     'er_twelve_total_mark' => get_label('er_twelve_total_mark'),
                             	     'er_family_yearly_income' => get_label('er_family_yearly_income'),
                             	     );
