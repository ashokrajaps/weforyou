					...
					<div class="card-body">
						...
						<?php echo form_open_multipart(admin_url().$module.'/edit/'.$result['cmspage_id'],' class="form-horizontal" id="common_form" autocomplete="'.form_autocomplte(). '"' );?>	
							...
							<div class="form-group">
								...
								<div class="col-sm-<?php echo get_form_size();?>"><div class="input_box"><?php  echo form_input('cms_slug',stripslashes($result['cmspage_slug']),' class="form-control required" readonly="readonly"  ');?></div></div>
