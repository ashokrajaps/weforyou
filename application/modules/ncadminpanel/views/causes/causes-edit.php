			...
			<div class="col-xs-12">
				<div class="card">
					...
					<?php echo form_open_multipart(admin_url().$module."/$module_action",' class="form-horizontal" id="common_form" ' );?>
                         ...
                         <div class="form-group">
							...
							<div class="col-sm-<?php echo get_form_size();?>"><div class="input_box"><?php  echo form_input('causes_title',stripslashes($records['causes_title']),' class="form-control required"  ');?></div></div>
						</div>
						<div class="form-group">
							<label for="causes_description" class="col-sm-2 control-label"><?php echo get_label('causes_description').get_required();?></label>
							<div class="col-sm-<?php echo get_form_size();?>"><div class="input_box"><?php  echo form_textarea('causes_description',stripslashes($records['causes_description']),' class="form-control required"  ');?></div></div>
						</div>						 
                         <div class="form-group">
							<label for="causes_budget" class="col-sm-2 control-label"><?php echo get_label('causes_budget').get_required();?></label>
							<div class="col-sm-<?php echo get_form_size();?>"><div class="input_box"><?php  echo form_input('causes_budget',stripslashes($records['causes_budget']),' class="form-control required number"  onkeypress="return isNumber(event)" ');?></div></div>
						</div>
				...
				<div class="form-group">
                    <label for="causes_is_donation_need" class="col-sm-2 control-label"><?php echo get_label('causes_is_donation_need').get_required();?></label>
						<div class="col-sm-<?php echo get_form_size();?>">
								<?php if($records['causes_is_donation_need']=="1") { $checked = 'checked="checked"'; } else {$checked=''; }; ?>							
							 <div class="checkbox-inline">
										<?php  echo form_radio('causes_is_donation_need','yes',$checked,'id="causes_is_donation_need" onClick="select_donation_rnr()" class="radio required"'); ?>
								<label for="causes_is_donation_need" class="chk_box_label">Yes</label>
							</div>
							<div class="checkbox-inline">
								<?php if($records['causes_is_donation_need']=="0") { $checked1 = 'checked="checked"'; } else {$checked1=''; }; ?>								
										<?php  echo form_radio('causes_is_donation_need','no',$checked1,'id="causes_is_donation_need" onClick="select_donation_rnr()"  class="radio required"'); ?>
                         ...
                         <div class="form-group"  id="how_much_donation_need_div">
							...
							<div class="col-sm-<?php echo get_form_size();?>"><div class="input_box"><?php  echo form_input('causes_how_much_donation_need',stripslashes($records['causes_how_much_donation_need']),'id="causes_how_much_donation_need" class="form-control required number"  onkeypress="return isNumber(event)"  ');?></div></div>
						</div>
				...
				<div class="form-group">
                    <label for="causes_is_volunteers_needed" class="col-sm-2 control-label"><?php echo get_label('causes_is_volunteers_needed').get_required();?></label>
						<div class="col-sm-<?php echo get_form_size();?>">
							 <div class="checkbox-inline">
								<?php if($records['causes_is_volunteers_needed']=="0") { $checked1 = 'checked="checked"'; } else {$checked1=''; }; ?>							 	
                         ...
                         <div class="form-group"  id="how_much_volunteers_need_div">
							...
							<div class="col-sm-<?php echo get_form_size();?>"><div class="input_box"><?php  echo form_input('causes_how_much_volunteers_need',stripslashes($records['causes_how_much_volunteers_need']),'id="causes_how_much_volunteers_need" class="form-control required number"  onkeypress="return isNumber(event)"  ');?></div></div>
						</div>
				...
				<div class="form-group">
                    <label for="causes_show_home_page" class="col-sm-2 control-label"><?php echo get_label('causes_show_home_page').get_required();?></label>
						<div class="col-sm-<?php echo get_form_size();?>">
							 <div class="checkbox-inline">
								<?php if($records['causes_show_home_page']=="yes") { $home_page_checked = 'checked="checked"'; } else {$home_page_checked=''; }; ?>								

										<?php  echo form_radio('causes_show_home_page','yes',$home_page_checked,'id="yes"  class="radio required"'); ?>
								<label for="yes" class="chk_box_label">Yes</label>
							</div>
							<div class="checkbox-inline">
								<?php if($records['causes_show_home_page']=="no") { $home_page_checked1 = 'checked="checked"'; } else {$home_page_checked1=''; }; ?>								

										<?php  echo form_radio('causes_show_home_page','no',$home_page_checked1,'id="no"  class="radio required"'); ?>
						...
						<div class="form-group">
							<label for="causes_status" class="col-sm-2 control-label"><?php echo get_label('status').get_required();?></label>
							<div class="col-sm-<?php echo get_form_size();?>"><div class="input_box"><?php  echo get_status_dropdown_causes($records['causes_status'],'','class="required" style="width:374px;" ');;?></div></div>
						</div>
					...
					<?php
					echo form_hidden('edit_id',$records['causes_id']);
