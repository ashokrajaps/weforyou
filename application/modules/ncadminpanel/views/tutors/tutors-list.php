                           ...
                           <?php echo form_open('',' id="common_search" class="form-inline"');?>
                            <div class="form-group">
                             <?php  $search_array = array(
                             		 '' => get_label('select'),
                             	     'tutor_name' => get_label('tutor_name'),
                             	     'tutor_location' => get_label('tutor_location'),
                             	     'tutor_subject' => get_label('tutor_subject'),
                             	     'tutor_city' => get_label('tutor_city'),
                             	     'tutor_email' => get_label('tutor_email'));
