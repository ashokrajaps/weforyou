                           ...
                           <?php echo form_open('',' id="common_search" class="form-inline"');?>
                            <div class="form-group">
                             <?php  $search_array = array(
                             		 '' => get_label('select'),
                                     'volunteer_first_name' => get_label('volunteer_first_name'),
                             	     'volunteer_last_name' => get_label('volunteer_last_name'),
                             	     'volunteer_mobile_no' => get_label('volunteer_mobile_no'),
                             	     'volunteer_email' => get_label('volunteer_email'),
                             	     );
