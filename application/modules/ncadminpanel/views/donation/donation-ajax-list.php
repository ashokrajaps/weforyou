...
<table class="table ">
	<thead class="first">
		<tr>
			...
			<th><?php echo get_label('donar_contact_no');?><?php echo add_sort_by('donar_contact_no',$module); ?></th>
			<th><?php echo get_label('transaction_total_amount');?><?php echo add_sort_by('transaction_total_amount',$module); ?></th>
