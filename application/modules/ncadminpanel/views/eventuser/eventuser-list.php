                           ...
                           <?php echo form_open('',' id="common_search" class="form-inline"');?>
                            <div class="form-group">
                             <?php  $search_array = array(
                             		 '' => get_label('select'),
                                     'event_title' => get_label('event_title_name'),
                                     'donar_event_team_name' => get_label('donar_event_team_name'),
                             	     'donar_refer_id' => get_label('donar_refer_id'),
                                     'donar_email_address' => get_label('event_email_address'),
                                     'donar_contact_no' => get_label('event_contact_no'),
                             	     'donar_alternative_contact_no' => get_label('event_alternative_contact_no'),
                             	     );
