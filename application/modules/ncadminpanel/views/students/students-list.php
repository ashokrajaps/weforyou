                           ...
                           <?php echo form_open('',' id="common_search" class="form-inline"');?>
                            <div class="form-group">
                             <?php  $search_array = array(
                             		 '' => get_label('select'),
                             	     'stu_first_name' => get_label('stu_first_name'),
                             	     'stu_location' => get_label('stu_location'),
                             	     'stu_father_name' => get_label('stu_father_name'),
                             	     'stu_course_name' => get_label('stu_course_name'),
                             	     'stu_email' => get_label('stu_email'));
