				...
				<!------ Error msg-----> 
                    ...
                    <div class="login_wrap" id="login_wrap">
						...
						<div class="button_group">
								<a href="javascript:void(0)" class="y_type doc_type" id="sign_home_Physician">Physician</a>
								<a href="javascript:void(0)" class="sep_btn">|</a>
								<a href="javascript:void(0)" class="y_type active doc_type" id="sign_non_home_Physician">Non Physician</a>
							</div>
						...
						<div class="" id="login_section">	
							...
							<input type="hidden" name="user_types" id="user_types" class="user_types"> 											
					   ...
					   <div class="" id="registration_section" style="display:none"> 
							...
							<input type="hidden" name="users_type" id="users_type" class="user_types">  						   
							<div class="login_wrap" id="login_wrap">
								<div class="">
					   ...
					   <div class="" id="forgot_section" style="display:none"> 
						  ...
						  ?>						   
							...
							<div class="forgot_link">
                             <a href="javascript:void(0)" class="link_txt signin_btn" id="forget_back_to_login" >
