    ...
    <div class="modal-dialog user-setting-popup" role="document">
        <div class="modal-content">
					...
					<div class="form-group">
						...
						<div class="input-group">
							<div class="input-group-addon">www.releaf.com/</div>
								<input type="text" class="form-control required border-right-hid" id="user_name_slug" name="user_name_slug" placeholder="type your user name here" value="<?php echo stripslashes($profile['user_name_slug']);  ?>">
						...
						<div class="checkbox custom-checkbox">
							<input type="radio" id="t-option" name="block_mature_content">
			...
			<div class="modal-footer">
				<button type="button" id="deactivate_account" class="btn-danger btn-red"><i class="fa fa-trash-o" aria-hidden="true"></i>Deactivate account</button>
