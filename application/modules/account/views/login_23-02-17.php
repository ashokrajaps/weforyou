...
?>
<div id="loginpopup" class="modal without_header_popup fade loginpopup" tabindex="-1" role="dialog" aria-labelledby="loginpopup">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body login_popup">
			...
			<!------ success msg----->
				...
				<!------ Error msg-----> 
                    ...
                    <div class="login_wrap" id="login_wrap">
					   ...
					   <div class="" id="registration_section" style="display:none"> 
                        ...
                        <div class="forgot_link">
                          <a href="javascript:void(0)" class="link_txt signin_btn" > <?php echo get_label('login'); ?> </a>							
                            <p><?php echo get_label('forgot_password'); ?> <a href="javascript:void(0)" class="link_txt forgot_btn" >Get help </a></p>
                        </div>	
						<?php echo form_close();?>                        												   
					   </div>
                ...
                <p class="serv_text">Creating an account means you’re OK with RxLeaf’s <a href="#">Terms of Service</a> and <a href="#">Privacy Policy</a></p>
          </div>
