                    ...
                    <div class="login_wrap" id="login_wrap">
						...
						<div class="" id="login_section">	
							...
							<div class="button_group">
								<a href="javascript:void(0)" class="y_type" id="sign_home_Physician">Physician</a>
								<a href="javascript:void(0)" class="sep_btn">|</a>
								<a href="javascript:void(0)" class="y_type active" id="sign_non_home_Physician">Non Physician</a>
							</div>												   
					   ...
					   <div class="" id="registration_section" style="display:none"> 
							...
							<div class="button_group">
								<a href="javascript:void(0)" class="x_type" id="sign_Physician">Physician</a>
								 <a href="javascript:void(0)" class="sep_btn">|</a>
								<a href="javascript:void(0)" class="x_type active" id="sign_non_Physician">Non Physician</a>
							</div>												   
							...
							<div class="login_wrap" id="login_wrap">
								<div class="">
                                    ...
                                    <div class="input_field"  id="certificate_no_holder">
											  <?php echo form_input('certificate_no',set_value('certificate_no'),' class="form-control" placeholder="Physician Certificate Number"  ');?>
									</div>																
								</div>
...
<script>
	$(document).ready(function() { 
		$('#sign_home_Physician,#sign_Physician').on('click', function() {
			$('#social_icon').hide();
			...
			$('#sign_Physician').addClass('x_type active');
						   var data_x=$(this).attr('id');
						   if(data_x=="sign_home_Physician")
						   {
								$('#sign_home_Physician').addClass('active');
								$('#sign_non_home_Physician').removeClass('active');
								$('#user_types').val(data_x);
						   }
						   else if(data_x=="sign_non_home_Physician")
						   {   
								$('#social_icon').show();							   
								$('#sign_non_home_Physician').addClass('active');
								$('#sign_home_Physician').removeClass('active');
								$('#user_types').val(data_x);
						   }			
		
		});
	
		$('#join_link,#sign_non_home_Physician,#sign_non_Physician').on('click', function() { 
			$('#social_icon').show();
			$('#certificate_no_holder').hide();			
			...
			$('#sign_non_Physician').addClass('x_type active');
						   var data_y=$(this).attr('id'); 
						   if(data_y=="sign_Physician")
						   {
								$('#sign_Physician').addClass('active');
								$('#sign_non_Physician').removeClass('active');
								$('#users_type').val(data_y);
								$('#certificate_no_holder').show();									
						   }
						   else if(data_y=="sign_non_Physician")
						   {   
								$('#sign_non_Physician').addClass('active');
								$('#sign_Physician').removeClass('active');
								$('#users_type').val(data_y);
								$('#certificate_no_holder').hide();
