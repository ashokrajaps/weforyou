...
class paypal_lib {
	...
	function paypal_auto_form() 
	{
		...
		echo '<!DOCTYPE html>' . "\n";
		echo '<head><meta charset="utf-8"><meta name="viewport" content="width=device-width initial-scale=1.0 maximum-scale=1.0 user-scalable=yes" /><title>Processing Payment...</title></head>' . "\n";
		echo '<body style="text-align:center;" onLoad="document.forms[\'paypal_auto_form\'].submit();">' . "\n";
		echo '<div style="width: 100%; text-align:center; display: table; height: 100%; position: absolute; left:0; top:0;">' . "\n";
		echo '<div style="width: 96%; display: table-cell; vertical-align: middle; padding: 0 2%;">' . "\n";
		echo '<p style=" font: normal 14px/22px airal; color:#000; margin: 0;">Transaction is being processed <br/>Please wait...</p>' . "\n";
		echo '<img src="'.skin_url().'images/payment-loader.gif" alt="loading" style="margin: 7px 0;" />' . "\n";
		echo '<p style=" font: normal 14px/22px airal; color:#ed1c24; margin: 0;">(Please do not press "Refresh" or "Back" button)</p>' . "\n";
